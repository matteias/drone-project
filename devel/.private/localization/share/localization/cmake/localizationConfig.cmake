...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/pascal/dd2419_ws/src/localization)
  set(localization_DEVEL_PREFIX /home/pascal/dd2419_ws/devel/.private/localization)
  ...
  set(localization_INSTALL_PREFIX /home/pascal/dd2419_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pascal/dd2419_ws/src/localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pascal/dd2419_ws/devel/.private/localization/lib;/home/pascal/dd2419_ws/devel/lib;/opt/ros/melodic/lib)
