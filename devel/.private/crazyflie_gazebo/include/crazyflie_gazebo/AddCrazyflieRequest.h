...
bool operator==(const ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator1> & lhs, const ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator2> & rhs)
{
  return lhs.uri == rhs.uri &&
    ...
    lhs.enable_logging_setpoint_pose == rhs.enable_logging_setpoint_pose;
}
